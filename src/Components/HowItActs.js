    ...
    return (
        <Container >
            <Box textAlign="center">
                ...
                <Typography variant="h6" className={classes.headingSubText} component="h6">
                    Businesses generally promote their brand, products,
                    and services by identifying audiance
                </Typography>
                    ...
                    <Card className={classes.cardStyle}>
                        ...
                        <CardContent>
                            ...
                            <Typography variant="h6" className={classes.cardText} >
                                Redefining digital marketing with the influencers that help your brand grow.
                            </Typography>
                        </CardContent>
                    </Card>
                </Grid>
                <Grid item sm={12} xs={12} md={3} lg={3} >
                    <Card className={classes.cardStyle}>
                        ...
                        <CardMedia>
                            ...
                            <Typography variant="h6" className={classes.cardText} >
                            Digital media trends across all social media platforms, leave it to us to break the internet.                            </Typography>
                        </CardContent>
                    </Card>
                </Grid>
                <Grid item sm={12} xs={12} md={3} lg={3} >
                    <Card className={classes.cardStyle}>
                        ...
                        <CardMedia>
                            ...
                            <Typography variant="h6" className={classes.cardText} >
                            Shaping emerging brands while envisioning their digital growth with potential brand placements.                            </Typography>
                        </CardContent>
                    </Card>
                </Grid>
                <Grid item sm={12} xs={12} md={3} lg={3} >
                    <Card className={classes.cardStyle}>
                        ...
                        <CardMedia>
                            ...
                            <Typography variant="h6" className={classes.cardText} >
                            We tell stories that your audience needs to hear and see. We produce the magic in HD.
                            </Typography>
                        </CardContent>
                    </Card>
                </Grid>
